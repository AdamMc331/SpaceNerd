...
class TSDExpeditionService(
    ...
    /**
     * The TSD API does not let us filter for active expeditions.
     * So if the [ExpeditionListRequest.isActive] field is true,
     * we will pass in the current date to filter for expeditions
     * that started before today. Then, we will filter the API response
